...
import { toInteraction, GenericInteractionEvent, distanceInteraction } from "./interaction";
...
export const useDnDMouseSourceHandle = <T extends Element>(ref: React.RefObject<T | null | undefined>, threshold = 10): MouseHandleRenderProps<T> => {
    ...
    const onMouseDown = useCallback(
        (e: GenericInteractionEvent) => {
            ...
            doc.addEventListener(`mouseup`, onMouseUp, { capture: true, passive: true });
...
export const useDnDMouseTargetContainer = <T extends Element>(ref: React.RefObject<T | null | undefined>): MouseTargetRenderProps<T> => {
