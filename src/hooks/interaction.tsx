...
export const isInteractionSame = (l: Interaction | null, r: Interaction | null) => (
    l === r || ((l && r)
...
export type GenericInteractionEvent = PointerEvent | MouseEvent | React.PointerEvent | React.MouseEvent;

export const toInteraction = (el: Element | undefined | null, e: GenericInteractionEvent): Interaction => {
    return {
