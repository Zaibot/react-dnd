...
export class DraggingProvider extends React.Component<
  IDraggingProviderProps,
  IDraggingInterface
> {
...
export const withDragAndDropData = <P extends {}>(
  Inner: React.ComponentType<
    P & IDraggingProviderRenderProps & { ref?: React.Ref<{}> }
  >
) =>
